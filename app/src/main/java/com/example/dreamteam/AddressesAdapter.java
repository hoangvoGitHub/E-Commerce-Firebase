...
import static com.example.dreamteam.MyAccountFragment.MANAGE_ADDRESS;
import static com.example.dreamteam.MyAddressesActivity.refreshItem;
...
public class AddressesAdapter extends RecyclerView.Adapter<AddressesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        String fullname = addressesModelList.get(position).getName();
            ...
            if (MODE == SELECT_ADDRESS) {
                ...
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        listener.onClick(
                                addressesModelList.get(position)
                        );
...
//                        }
    ...
    public interface OnAddressActionListener {
        void onClick(AddressesModel model);
    }
}
